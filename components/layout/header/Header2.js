...
export default function Header2({ scroll, isSidebar, handleSidebar, isMobileMenu, handleMobileMenu, handleSearch }) {
    return (
        <>
            <header className={`main-header header-sticky header-style-2 bg-white ${scroll ? "sticky-bar" : ""}`}>
                {/*Main navigation*/}
                <div className="container">
                    ...
                    {/*Logo and tagline */}
                    <div className="header-logo text-center pt-30 pb-30 d-none d-md-block">
                        <h1 className="font-secondary"><Link href="/">Athena</Link></h1>
