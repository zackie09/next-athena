...
import SliderCenter3 from "@/components/slider/SliderCenter3"
                ...
                <div>
                    ...
                    <div className="container mb-30 mt-50">
                        <div className="sidebar-widget post-module-1">
                            <div className="widget-header-5 font-primary mb-30 text-center">
                                <h3 className="widget-title mt-5 mb-30">Recent Stories</h3>
                            </div>
                            <div className="row mb-30">
                                ...
                                <BlogPost showItem={4} showStart={0} showEnd={10} style={6} showPagination col="col-lg-3 col-md-6 mb-50" />                               
                            </div>
                        </div>
                    </div>
